...
/** Alias for {@link parse} — matches the POC's naming. */
export const parseCryo = parse;

/** Alias for {@link parseUrl} — matches the POC's naming. */
export const loadCryo = parseUrl;
